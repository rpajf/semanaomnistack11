...
//cannot import only compose async function
//so all the exportations from this package are
//available in the variable MailComposer
...
export default function Detail() {
  ...
  //all the params sent from the route on the 
  const message = 
